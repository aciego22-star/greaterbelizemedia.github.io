...
from web_fetch import (  # polite fetching lives in one place now
    MAX_CRAWL_DELAY, MAX_INTERNAL_PAGES, REQUEST_DELAY, SKIP_IF_CRAWL_DELAY_OVER,
    USER_AGENT, RobotsCache, fetch_html, is_social_media, normalize_url,
    page_text,
)
