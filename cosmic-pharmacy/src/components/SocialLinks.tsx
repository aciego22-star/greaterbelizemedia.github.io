...
interface SocialLink {
  ...
  label: string;
  href: string;
  /** Brand colour used on hover/focus. */
  tint: string;
  icon: JSX.Element;
}
...
const socials: SocialLink[] = [
  ...
  },
  {
    ...
    tint: '#ea4335',
    icon: (
      <path d="M21.6 12.2c0-.7-.06-1.35-.18-2H12v3.8h5.4a4.6 4.6 0 0 1-2 3v2.5h3.2c1.9-1.75 3-4.3 3-7.3ZM12 22c2.7 0 4.96-.9 6.6-2.4l-3.2-2.5c-.9.6-2.05.95-3.4.95-2.6 0-4.8-1.75-5.6-4.1H3.1v2.6A10 10 0 0 0 12 22ZM6.4 13.95a6 6 0 0 1 0-3.85V7.5H3.1a10 10 0 0 0 0 9l3.3-2.55ZM12 5.9c1.47 0 2.8.5 3.83 1.5l2.87-2.87A10 10 0 0 0 3.1 7.5l3.3 2.6C7.2 7.65 9.4 5.9 12 5.9Z" />
    )
  },
  {
    key: 'email',
...
/**
 * Footer social row. Each icon drifts on its own slow rhythm so the row feels
 * alive without demanding attention; motion stops under prefers-reduced-motion.
 */
