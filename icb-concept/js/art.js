...
(function () {
  ...
  /* Glyph library                                                       */
  /* ------------------------------------------------------------------ */
  /* Drawn on a 24px grid with a consistent 1.6 stroke, optical centring
     and a shared visual weight, so a row of them reads as one set rather
     than a pile of stock icons. Shapes lean specific over generic: the
     boat is a Belizean skiff, the container is a shipping container with
     its corner castings, the road runs to a vanishing point. */
  var GLYPH_PATHS = {
    /* Task and product marks */
    shield: '<path d="M12 2.9l7.3 2.55v5.2c0 4.63-2.93 8.7-7.3 10.45C7.63 19.35 4.7 15.28 4.7 10.65v-5.2z"/><path d="M9.15 11.9l2 2.05 3.7-4.15"/>',
    document: '<path d="M6.6 2.9h7.05l4.35 4.35V21.1H6.6z"/><path d="M13.4 2.95v4.5h4.5"/><path d="M9.4 12.3h5.2M9.4 15.7h5.2M9.4 18.2h3"/>',
    card: '<rect x="2.9" y="5.6" width="18.2" height="12.8" rx="2.4"/><path d="M2.9 9.7h18.2"/><path d="M6.4 14.6h3.3"/><path d="M16.3 14.6h1.6"/>',
    marker: '<path d="M12 21.3c0 0-6.75-6.06-6.75-10.68A6.75 6.75 0 0112 3.9a6.75 6.75 0 016.75 6.72c0 4.62-6.75 10.68-6.75 10.68z"/><circle cx="12" cy="10.5" r="2.55"/>',
    briefcase: '<rect x="2.9" y="7.5" width="18.2" height="12.1" rx="2.2"/><path d="M8.85 7.5V5.9a2 2 0 012-2h2.3a2 2 0 012 2v1.6"/><path d="M2.9 12.6h18.2"/><path d="M10.4 11.7h3.2v1.9h-3.2z"/>',
    chat: '<path d="M20.6 11.35c0 3.79-3.85 6.86-8.6 6.86a10 10 0 01-2.42-.29L4.6 19.7l1.1-3.53a6.35 6.35 0 01-2.3-4.82C3.4 7.56 7.25 4.5 12 4.5s8.6 3.06 8.6 6.85z"/><path d="M8.7 11.3h.02M12 11.3h.02M15.3 11.3h.02" stroke-width="2.1"/>',
    house: '<path d="M3.6 11.1L12 3.7l8.4 7.4"/><path d="M5.85 9.6v9.85a1 1 0 001 1h10.3a1 1 0 001-1V9.6"/><path d="M9.8 20.45v-5.3a2.2 2.2 0 014.4 0v5.3"/>',
    car: '<path d="M4.35 13.1l1.72-4.72A2.4 2.4 0 018.32 6.8h7.36a2.4 2.4 0 012.25 1.58l1.72 4.72"/><path d="M3.5 13.1h17a1.2 1.2 0 011.2 1.2v2.55a1 1 0 01-1 1h-1.6M3.5 13.1a1.2 1.2 0 00-1.2 1.2v2.55a1 1 0 001 1h1.6M9.2 17.85h5.6"/><circle cx="6.7" cy="17.55" r="1.75"/><circle cx="17.3" cy="17.55" r="1.75"/>',
    boat: '<path d="M2.9 16.2h18.2l-2.3 3.55a1.6 1.6 0 01-1.34.72H6.54a1.6 1.6 0 01-1.34-.72z"/><path d="M6.3 16.2l.75-4.3h9.9l.75 4.3"/><path d="M12 11.9V3.3l5.9 5.2a.55.55 0 01-.36 1.02H12z"/>',
    container: '<rect x="2.7" y="7.1" width="18.6" height="10.5" rx="1.2"/><path d="M6.6 7.1v10.5M10.2 7.1v10.5M13.8 7.1v10.5M17.4 7.1v10.5"/><path d="M19.4 9.7v5.3"/>',
    scales: '<path d="M12 4.3v15.4M8.2 19.7h7.6"/><path d="M5.1 7.05l13.8-1.6"/><path d="M5.1 7.05L2.7 12.6a2.55 2.55 0 004.8 0zM18.9 5.45L16.5 11a2.55 2.55 0 004.8 0z"/><circle cx="12" cy="6.1" r="1.15"/>',
    plane: '<path d="M12 2.7c.95 0 1.65 1.2 1.65 3v2.9l7.65 4.45v2.15l-7.65-2.3v3.85l2.6 1.9v1.6L12 19.45l-4.25.8v-1.6l2.6-1.9V12.9L2.7 15.2v-2.15L10.35 8.6V5.7c0-1.8.7-3 1.65-3z"/>',
    border: '<path d="M5.2 20.3v-9.6"/><circle cx="5.2" cy="8.9" r="1.55"/><path d="M7.5 11.2h12.1a1.3 1.3 0 011.3 1.3v1.4a1.3 1.3 0 01-1.3 1.3H7.5z"/><path d="M11.6 11.2l-1.7 3.9M15.7 11.2L14 15.1"/><path d="M2.6 20.3h18.8"/>',
    road: '<path d="M5.9 20.5L10.1 4M18.1 20.5L13.9 4"/><path d="M12 6.3v2.4M12 11.1v2.4M12 15.9v2.4"/>',
    people: '<circle cx="9.2" cy="8.1" r="3.1"/><path d="M3.6 19.9a5.6 5.6 0 0111.2 0"/><path d="M16.1 5.55a3.1 3.1 0 010 5.1M17.6 14.6a5.6 5.6 0 012.8 5.3"/>',
    storm: '<path d="M7.5 15.6a3.9 3.9 0 01.3-7.8 5.2 5.2 0 019.7 1.05 3.4 3.4 0 01-.6 6.75z"/><path d="M5.6 18.6h8.2a1.9 1.9 0 10-1.9-1.9M8.4 21.4h6.4a1.7 1.7 0 10-1.7-1.7"/>',
    question: '<circle cx="12" cy="12" r="8.6"/><path d="M9.45 9.5a2.6 2.6 0 115.1.75c-.35 1.15-1.9 1.45-2.4 2.5a2.4 2.4 0 00-.15 1.05"/><circle cx="12" cy="16.85" r="0.75" fill="currentColor" stroke="none"/>',

    /* Utility marks */
    phone: '<path d="M7.35 3.5h2.6a1 1 0 01.96.72l1 3.4a1 1 0 01-.36 1.08l-1.7 1.26a11.9 11.9 0 004.19 4.19l1.26-1.7a1 1 0 011.08-.36l3.4 1a1 1 0 01.72.96v2.6a2.2 2.2 0 01-2.4 2.19A16.1 16.1 0 015.16 5.9 2.2 2.2 0 017.35 3.5z"/>',
    mail: '<rect x="2.9" y="5.2" width="18.2" height="13.6" rx="2.4"/><path d="M3.9 7.6l7.4 5.35a1.2 1.2 0 001.4 0l7.4-5.35"/>',
    external: '<path d="M10 5.5H5.5v13h13V14"/><path d="M13.5 4.5H19.5v6M19 5l-7.5 7.5"/>',
    download: '<path d="M12 3.9v10.6M7.9 10.7L12 14.8l4.1-4.1"/><path d="M4.2 18.1v1a1.9 1.9 0 001.9 1.9h11.8a1.9 1.9 0 001.9-1.9v-1"/>',
    play: '<path d="M8.6 5.6l10 6.4-10 6.4z" fill="currentColor" stroke-linejoin="round"/>',
    "sound-on": '<path d="M11.6 4.5L7 8.4H4a1.1 1.1 0 00-1.1 1.1v5a1.1 1.1 0 001.1 1.1h3l4.6 3.9a.6.6 0 001-.46V4.96a.6.6 0 00-1-.46z"/><path d="M15.5 9.6a3.4 3.4 0 010 4.8M18 7.1a7 7 0 010 9.8"/>',
    "sound-off": '<path d="M11.6 4.5L7 8.4H4a1.1 1.1 0 00-1.1 1.1v5a1.1 1.1 0 001.1 1.1h3l4.6 3.9a.6.6 0 001-.46V4.96a.6.6 0 00-1-.46z"/><path d="M16 9.8l4.6 4.4M20.6 9.8L16 14.2"/>',
    arrow: '<path d="M4.5 12h15M13.5 6l6 6-6 6"/>',
    "arrow-up": '<path d="M12 19.5v-15M5.6 10.9L12 4.5l6.4 6.4"/>',
    check: '<path d="M4.8 12.6l4.9 4.9L19.4 7.4"/>',
    compass: '<circle cx="12" cy="12" r="8.6"/><path d="M15.3 8.7l-2.1 4.6-4.5 2.1 2.1-4.6z"/><circle cx="12" cy="12" r="0.8" fill="currentColor" stroke="none"/>',
