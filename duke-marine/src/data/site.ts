...
export const nav: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: 'Rods & Reels', href: '/fishing-supplies#rods', desc: 'Spinning & conventional' },
      { label: 'Line & Leader', href: '/fishing-supplies#line', desc: 'Mono, braid, wire' },
      { label: 'Tackle & Terminal', href: '/fishing-supplies#tackle', desc: 'Hooks, swivels, sinkers' },
      { label: 'Lures', href: '/fishing-supplies#lures', desc: 'Minnows, trolling lures' },
      { label: 'Cast Nets', href: '/fishing-supplies#nets', desc: 'Bait nets' },
      { label: 'Tackle Boxes & Accessories', href: '/fishing-supplies#accessories', desc: 'Boxes, gaffs' },
    ],
  },
  {
    label: 'Diving',
    ...
    children: [
      { label: 'Masks & Snorkels', href: '/diving-supplies#masks', desc: 'Masks, snorkels, sets' },
      { label: 'Fins & Footwear', href: '/diving-supplies#fins', desc: 'Fins & dive booties' },
      { label: 'Spearfishing Equipment', href: '/diving-supplies#spearfishing', desc: 'Spearguns, poles' },
      { label: 'Replacement Parts & Accessories', href: '/diving-supplies#parts', desc: 'Bands, barbs, tubing' },
    ],
  },
