...
window.CuellosConfig = {
  ...
  heroVideo: {
    src: "assets/video/cuello-hero-video.mp4?v=2",          /* landscape - tablet/desktop */
    srcMobile: "assets/video/cuello-hero-video-mobile.mp4?v=2", /* native-resolution portrait crop - phones */
    poster: "assets/img/gallery/cuello-hero-video-poster.webp?v=2"
  }
};
